...
new #[\Livewire\Attributes\Layout('layouts.app')] class extends Component {
    ...
    public function save()
    {
        $this->validate([
            ...
            'disposisi_checkboxes' => 'nullable|array',
            'disposisi_custom' => 'nullable|string|max:1000',
        ...
        $data = [
            ...
            'tanggal_acara' => (count($this->detail_acaras) > 0 ? $this->detail_acaras[0]['tanggal'] : $this->tanggal_acara) ?: null,
            'waktu_acara' => (count($this->detail_acaras) > 0 ? $this->detail_acaras[0]['waktu'] : $this->waktu_acara) ?: null,
            ...
            'tgl_dikembalikan' => $this->tgl_dikembalikan ?: null,
