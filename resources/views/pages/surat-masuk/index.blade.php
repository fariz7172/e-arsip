...
<div>
    ...
    <div style="margin-bottom: 28px; display: flex; justify-content: space-between; align-items: flex-end; flex-wrap: wrap; gap: 16px;">
        ...
        <div style="display:flex; gap: 8px; flex-wrap: wrap;">
            <a href="{{ asset('assets/surat-masuk-template.xlsx') }}" download class="btn btn-secondary" style="display: inline-flex; align-items: center; gap: 6px;" title="Download Template Excel">
    ...
    @endif
    @if(session('error'))
        <div style="background: #fee2e2; color: #b91c1c; padding: 12px 16px; border-radius: 8px; margin-bottom: 20px; font-weight: 500; border: 1px solid #fecaca;">
            {{ session('error') }}
        </div>
    @endif
                ...
                <table style="min-width: 1500px; width: 100%; border-collapse: collapse;">
                    ...
                    <tbody>
                        @foreach($surats as $surat)
                            <tr>
                                <td style="text-align: center; font-weight: 700; color: var(--text-secondary);">{{ $surat->kode ?? '-' }}</td>
                                ...
                                <td style="text-align: center;">
                                    <div style="display: flex; gap: 6px; justify-content: center;">
                                        ...
                                        @endif
                                        <a href="/surat-masuk/{{ \Illuminate\Support\Facades\Crypt::encryptString($surat->id) }}/disposisi" target="_blank" class="btn btn-sm btn-secondary" style="padding: 4px 8px; color: #0284c7;" title="Cetak Disposisi">
                                            🖨️
                                        </a>
                                        <a href="/surat-masuk/{{ \Illuminate\Support\Facades\Crypt::encryptString($surat->id) }}/edit" class="btn btn-sm btn-secondary" style="padding: 4px 8px;" title="Edit">
                                            ✏️
                                        </a>
