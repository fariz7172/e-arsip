...
<head>
    ...
    <style>
        ...
        /* A4 Page styling */
        .print-area {
            background: white; width: max-content; min-width: 210mm; min-height: 297mm;
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('spnComponent', () => ({
                ...
                checklistSPN: @json($payment->print_data['checklistSPN'] ?? null) || [
                    ...
                    { "no_berkas": "", "no_item": "18", "kode": "/PPTK/", "uraian": "Permogonan Pemprosesan Tagihan Pihak Ketiga Pek. {{ $payment->keperluan ?? '...' }}", "tanggal": "{{ $payment->tgl_spm ?? '...' }}", "jumlah": "1", "keterangan": "Berkas" },
